...
<div class="wrapper-left" id="wrapper-left">
    ...
    <ul>
        <li>
            <a href="driverpage.php" data-li="dashboard" class="tablinks">
        ...
        <li>
            <a href="driverprofile.php" data-li="profile" class="tablinks">
        ...
        <li>
            <a href="" data-li="transaction" class="tablinks">
